...
import com.crm.user.repository.HolidayRepository;
import com.crm.user.repository.LeaveRequestRepository;
...
public abstract class BaseController {
    ...
    protected Map<String, Object> buildAnalyticsMap(java.util.List<com.crm.user.model.Task> tasks, java.util.List<com.crm.user.model.User> people, boolean countByCreator, boolean excludeHrManager) {
        var data = new java.util.LinkedHashMap<String, Object>();
        var scopedTasks = tasks != null ? tasks : java.util.Collections.<com.crm.user.model.Task>emptyList();
        var scopedPeople = people != null ? people : java.util.Collections.<com.crm.user.model.User>emptyList();
        ...
        var activeCount = scopedPeople.stream().filter(com.crm.user.model.User::isActive).count();
     ...
     */
    protected java.util.List<com.crm.user.model.AttendanceDay> buildDayList(
            java.util.List<com.crm.user.model.Attendance> records,
            LocalDate from, LocalDate to,
            Map<LocalDate, String> holidays,
            com.crm.user.model.User user) {

        var days = new java.util.ArrayList<com.crm.user.model.AttendanceDay>();
        if (from == null || to == null) return days;

        var byDate = new java.util.LinkedHashMap<LocalDate, com.crm.user.model.Attendance>();
        if (records != null) {
            for (var a : records) {
    ...
    private java.util.Set<LocalDate> collectApprovedLeaveDates(com.crm.user.model.User user, LocalDate from, LocalDate to) {
    ...
    private com.crm.user.model.AttendanceDay resolveAttendanceDay(
            LocalDate date,
            Map<LocalDate, String> holidays,
            Map<LocalDate, com.crm.user.model.Attendance> byDate,
            java.util.Set<LocalDate> approvedLeaveDates,
            LocalDate today) {

        if (holidays != null && holidays.containsKey(date)) {
            return new com.crm.user.model.AttendanceDay(date, holidays.get(date), true);
        }
        var dow = date.getDayOfWeek();
        if (dow == java.time.DayOfWeek.SATURDAY || dow == java.time.DayOfWeek.SUNDAY) {
            return new com.crm.user.model.AttendanceDay(date, "weekend");
        }
        if (byDate.containsKey(date)) {
            return new com.crm.user.model.AttendanceDay(byDate.get(date));
        }
        if (approvedLeaveDates.contains(date)) {
            return new com.crm.user.model.AttendanceDay(date, "leave");
        }
        if (!date.isAfter(today)) {
            return new com.crm.user.model.AttendanceDay(date, "absent");
        }
        return null;
    }
    ...
    protected java.util.List<java.util.Map<String, String>> buildAttendanceRows(
            java.util.List<com.crm.user.model.AttendanceDay> days) {
