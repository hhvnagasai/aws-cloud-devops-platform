...
import com.crm.user.model.Notification;
import com.crm.user.model.Task;
import com.crm.user.model.Team;
import com.crm.user.model.User;
import com.crm.user.repository.NotificationRepository;
...
public class NotificationService {
    ...
    public void notifyLeaveReviewed(User employee, String status, String leaveType,
        ...
        if (com.crm.user.controller.BaseController.STATUS_APPROVED.equalsIgnoreCase(status)) {
            notify(employee,
                    "Leave Request Approved",
                    "Your " + leaveType + " leave (" + period + ") was approved by " + reviewer + ".",
                    TYPE_LEAVE);
        } else if (com.crm.user.controller.BaseController.STATUS_REJECTED.equalsIgnoreCase(status)) {
            notify(employee,
